...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 344.0, 94.0, 75.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 412.0, 157.0, 207.0, 23.0 ],
...
,
									"text" : "param phaseVolume @min 0. @max 1.",
									"varname" : "phaseVolume"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 347.0, 251.0, 47.0, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 1,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 282.0, 251.0, 47.0, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 2,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 55.0, 27.0, 56.0, 23.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 193.0, 391.0, 207.0, 23.0 ],
...
,
									"text" : "buffer~ guitar @file janineGuitars.wav"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 183.0, 157.0, 190.0, 23.0 ],
									"rnbo_classname" : "param",
									"rnbo_extra_attributes" : 									{
										"exponent" : 1.0,
										"order" : "0",
...
,
									"text" : "param gitVolume @min 0. @max 1.",
									"varname" : "gitVolume"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 120.0, 311.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 61.0, 311.0, 43.0, 23.0 ],
									"rnbo_classname" : "out~",
									"rnbo_extra_attributes" : 									{
										"comment" : "",
										"meta" : ""
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 118.0, 251.0, 47.0, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 3,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "signal" ],
									"patching_rect" : [ 53.0, 251.0, 47.0, 23.0 ],
									"rnbo_classname" : "*~",
									"rnbo_serial" : 4,
