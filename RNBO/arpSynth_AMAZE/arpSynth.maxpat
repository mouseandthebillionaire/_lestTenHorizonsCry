...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "signal", "signal" ],
													"patching_rect" : [ 81.5, 262.0, 206.0, 23.0 ],
													"rnbo_classname" : "p",
													"rnbo_extra_attributes" : 													{
														"args" : [  ],
														"receivemode" : "local",
...
,
													"patching_rect" : [ 50.0, 336.0, 47.0, 23.0 ],
													"rnbo_classname" : "p",
													"rnbo_extra_attributes" : 													{
														"args" : [  ],
														"receivemode" : "local",
...
,
									"patching_rect" : [ 411.25, 805.0, 93.0, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"receivemode" : "local",
...
,
										"classnamespace" : "rnbo",
										"rect" : [ 1287.0, 148.0, 1088.0, 665.0 ],
										"bglocked" : 0,
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
,
									"patching_rect" : [ 789.5, 709.0, 95.0, 23.0 ],
									"rnbo_classname" : "p",
									"rnbo_extra_attributes" : 									{
										"args" : [  ],
										"receivemode" : "local",
...
,
						"shimmerSynth/ratio_1" : 						{
							"label" : "ratio_1",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/index_1" : 						{
							"label" : "index_1",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/del_1/left" : 						{
							"label" : "left",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/del_1/fb" : 						{
							"label" : "fb",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/del_1/right" : 						{
							"label" : "right",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/env.adsr/attack" : 						{
							"label" : "attack",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/env.adsr/decay" : 						{
							"label" : "decay",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/env.adsr/sustain" : 						{
							"label" : "sustain",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerSynth/env.adsr/release" : 						{
							"label" : "release",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerNotes/shimmerSpeed" : 						{
							"label" : "shimmerSpeed",
							"isEnum" : 0,
							"parsestring" : ""
						}
,
						"shimmerNotes/shimmerBredth" : 						{
							"label" : "shimmerBredth",
							"isEnum" : 0,
							"parsestring" : ""
						}
