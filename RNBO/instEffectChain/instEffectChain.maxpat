...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 27.666661858558655, 20.000000834465027, 162.0, 23.0 ],
...
,
		"dependency_cache" : [ 			{
				"name" : "strings.wav",
				"bootpath" : "~/_Projects/_lestTenHorizonsCry/RNBO/instEffectChain",
				"patcherrelativepath" : ".",
				"type" : "WAVE",
				"implicit" : 1
			}
